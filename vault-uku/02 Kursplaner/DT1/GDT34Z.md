...
- analysera och implementera metoder för att skapa, optimera, övervaka, felsöka och testa skalbara nätverksarkitekturer med avseende på både WAN- och LAN-teknologier utifrån CIA-triangeln,
...
- analysera och utvärdera icke-funktionella krav,
...
- Projekt med muntlig och praktisk redovisning

  - Laborationer med muntlig och praktisk redovisning
