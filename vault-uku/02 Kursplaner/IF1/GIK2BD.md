...
Kursen examineras genom tentamen (1,5 hp) samt aktivt deltagande i seminarier (1 hp), workshops (3 hp) och projekt som redovisas skriftligt och muntligt (2 hp).

## Arbetsformer

Föreläsningar, workshops, övningar, obligatoriska seminarier, presentationer och projekt.
...
Föreläsningar, instruktioner och material mm kan förekomma på engelska.
